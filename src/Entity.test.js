...
describe('Entity', () => {
  ...
  it('serializes patch request to include changes', async () => {
    const entity = new Entity('node', 'article', '04808c36-9a01-4503-952d-f4dd88a1186a')
    entity.setAttribute('body', { value: '<p>Drupal rocks!</p>' })
    let request
    GlobalClient.transport = (inp) => { request = inp; return Promise.resolve({ data: null }) }
    await entity.save()
  ...
  it('serializes post request to include entity information', async () => {
