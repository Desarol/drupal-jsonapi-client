...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var _QueryParameters=_interopRequireDefault(require("./QueryParameters"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}const withMimeType=e=>({...e,headers:{...e.headers,Accept:"application/vnd.api+json","Content-Type":"application/vnd.api+json"}});class Resource{static Get({type:e,id:t}){const[i,r]=e.split("--");return withMimeType({method:"GET",url:`/${i}/${r}/${t}`})}static GetList({type:e,filter:t=null,include:i=[],offset:r=0,limit:a=50}){const[u,s]=e.split("--"),n=[`page[offset]=${r}`,`page[limit]=${a}`];null!=t&&n.push("function"==typeof t.query?t.query():t),i.length>0&&n.push(`include=${i.join(",")}`);const p=new _QueryParameters.default(n);return withMimeType({method:"GET",url:`/${u}/${s}?${p.toString(Number.MAX_SAFE_INTEGER)}`})}static New({type:e,data:t={}}){const[i,r]=e.split("--");return withMimeType({url:`/${i}/${r}`,method:"POST",data:JSON.stringify({type:e,...t})})}static Update({type:e,id:t,data:i={}}){const[r,a]=e.split("--");return withMimeType({url:`/${r}/${a}/${t}`,method:"PATCH",data:JSON.stringify({type:e,id:t,...i})})}}var _default=Resource;exports.default=_default;

},{"./QueryParameters":5}],7:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"Filter",{enumerable:!0,get:function(){return _Filter.default}}),Object.defineProperty(exports,"FilterGroup",{enumerable:!0,get:function(){return _FilterGroup.default}}),Object.defineProperty(exports,"QueryParameters",{enumerable:!0,get:function(){return _QueryParameters.default}}),Object.defineProperty(exports,"Resource",{enumerable:!0,get:function(){return _Resource.default}}),Object.defineProperty(exports,"FileResource",{enumerable:!0,get:function(){return _FileResource.default}});var _Filter=_interopRequireDefault(require("./Filter")),_FilterGroup=_interopRequireDefault(require("./FilterGroup")),_QueryParameters=_interopRequireDefault(require("./QueryParameters")),_Resource=_interopRequireDefault(require("./Resource")),_FileResource=_interopRequireDefault(require("./FileResource"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}

},{"./FileResource":2,"./Filter":3,"./FilterGroup":4,"./QueryParameters":5,"./Resource":6}]},{},[1])(1)
});
