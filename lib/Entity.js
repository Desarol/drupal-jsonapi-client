...
function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                _context.next = 5;
                return _GlobalClient.default.send(new Request("/jsonapi/".concat(entityType, "/").concat(entityBundle, "/").concat(entityUuid)));
  ...
  function Entity(entityType, entityBundle, entityUuid, requiredFields) {
    var _this = this;
