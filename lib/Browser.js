  ...
  _createClass(Client, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee2(request) {
        var url, body, cache, credentials, headers, integrity, method, mode, redirect, referrer, referrerPolicy, credentialsCopy, urlCopy, urlObject, bodyCopy, copy, xCsrfToken, i, response;
